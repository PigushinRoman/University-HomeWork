...
#Допустим что N = 10; m = 200; Ai = [10,20,30,40,50,60,70,80,90] - ответ должен быть 5
#Алгоритм в while я подсмотрел если что, я понятия не имею как должен был догадаться до него используя только то что дали в курсе
